...
14. **Prod D1 / visitors errors** — If `/visitors` fails after deploy, confirm **`bun run deploy`** (or **`alchemy deploy --app cf-starter-db`**) completed and D1 migrations ran; see [Alchemy D1Database](https://alchemy.run/providers/cloudflare/d1-database/).
