/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.temp.json` (hash: faf2eaa0977f4e3e753ce76e81ac93a5)
// Runtime types generated with workerd@1.20250803.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SESSION_SECRET: string;
		VALUE_FROM_CLOUDFLARE: string;
		TestDo: DurableObjectNamespace<import("./workers/app").TestDo>;
	}
}
