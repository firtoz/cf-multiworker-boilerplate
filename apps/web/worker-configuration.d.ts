/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../../durable-objects/coordinator-do/wrangler.jsonc -c ../../durable-objects/example-do/wrangler.jsonc -c ../../durable-objects/processor-do/wrangler.jsonc --env-file .env.example --env-file .env` (hash: 7a95c6fd9314f2504db372576bd4b6b1)
// Runtime types generated with workerd@1.20260205.0 2025-12-17 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SECRET" | "VALUE_FROM_CLOUDFLARE">> {}
}
